...
script_ver<-'imagery_georef-PR-TUG_2-offset.R'
...
shaRe::export_dictionary(description=txt, varTable= geo_dict, path='output/datasets/photogrammetry/georeferenced_images-PR-TUG_2-offset-dictionary.txt', formatTable='long')

write.csv(geo_pics,file='output/datasets/photogrammetry/georeferenced_images-PR-TUG_2-offset.csv', quote=F, row.names=F)
