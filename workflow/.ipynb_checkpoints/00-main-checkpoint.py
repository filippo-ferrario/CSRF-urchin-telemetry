...
ALL_TCM = [
    DATA_RAW / tcm.BIC_ANSE_DES_PILOTES_TCM,
    DATA_RAW / tcm.BIC_LA_BALEINE_TCM,
    DATA_RAW / tcm.CACOUNA_ILE_AUX_LIEVRES_1_TCM,
    DATA_RAW / tcm.CACOUNA_ILE_AUX_LIEVRES_2_TCM,
    DATA_RAW / tcm.RUPERT_TUGWELL_1_TCM,
    DATA_RAW / tcm.RUPERT_TUGWELL_2_TCM,
    DATA_RAW / tcm.QUADRA_MARINA_1_TCM,
    DATA_RAW / tcm.QUADRA_MARINA_2_TCM,
]
