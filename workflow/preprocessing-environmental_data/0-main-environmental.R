...
generate.plots.zoom(TCM_temp2,
                    ...
                    name_vec = c("QC_TCMTemp_rollmean_2hours_zoom1.png",
                                 "QC_TCMTemp_rollmean_3hours_zoom1.png",
                                 "QC_TCMTemp_rollmean_6hours_zoom1.png"),
...
generate.plots.zoom(aqua2,
                    ...
                    name_vec = c("QC_AquaTemp_rollmean_2hours_zoom1.png",
                                 "QC_AquaTemp_rollmean_3hours_zoom1.png",
                                 "QC_AquaTemp_rollmean_6hours_zoom1.png",
                                 "QC_AquaSal_rollmean_2hours_zoom1.png",
                                 "QC_AquaSal_rollmean_3hours_zoom1.png",
                                 "QC_AquaSal_rollmean_6hours_zoom1.png"),
                    y_vec = c("Temperature (C)", "Temperature (C)", "Temperature (C)",
...
generate.plots.zoom(star2,
                    ...
                    roundvar_vec = c("temp_ma02", "temp_ma03", "temp_ma04",
                                     "sal_ma02", "sal_ma03", "sal_ma04"),
                    name_vec = c("QC_StarTemp_rollmean_2hours_zoom1.png",
                                 "QC_StarTemp_rollmean_3hours_zoom1.png",
                                 "QC_StarTemp_rollmean_6hours_zoom1.png",
                                 "QC_StarSal_rollmean_2hours_zoom1.png",
                                 "QC_StarSal_rollmean_3hours_zoom1.png",
                                 "QC_StarSal_rollmean_6hours_zoom1.png"),
                    y_vec = c("Temperature (C)", "Temperature (C)", "Temperature (C)",
                              "Salinity (psu)", "Salinity (psu)", "Salinity (psu)"),
                    time_vec = c("2022-09-01 00:00:00", "2022-09-07 00:00:00"),
                    save_loc = here("output/plots/"))
...
generate.plots.zoom(TCM_temp2,
                    origvar_vec = c("Temperature", "Temperature", "Temperature"),
                    roundvar_vec = c("temp_ma02", "temp_ma03", "temp_ma04"),
                    name_vec = c("QC_TCMTemp_rollmean_2hours_zoom2.png",
                                 "QC_TCMTemp_rollmean_3hours_zoom2.png",
                                 "QC_TCMTemp_rollmean_6hours_zoom2.png"),
                    y_vec = c("Temperature (C)", "Temperature (C)", "Temperature (C)"),
...
generate.plots.zoom(aqua2,
                    ...
                    roundvar_vec = c("temp_ma02", "temp_ma03", "temp_ma04",
                                     "sal_ma02", "sal_ma03", "sal_ma04"),
                    name_vec = c("QC_AquaTemp_rollmean_2hours_zoom2.png",
                                 "QC_AquaTemp_rollmean_3hours_zoom2.png",
                                 "QC_AquaTemp_rollmean_6hours_zoom2.png",
                                 "QC_AquaSal_rollmean_2hours_zoom2.png",
                                 "QC_AquaSal_rollmean_3hours_zoom2.png",
                                 "QC_AquaSal_rollmean_6hours_zoom2.png"),
                    y_vec = c("Temperature (C)", "Temperature (C)", "Temperature (C)",
                              "Salinity (psu)", "Salinity (psu)", "Salinity (psu)"),
                    time_vec = c("2022-09-01 00:00:00", "2022-09-02 00:00:00"),
                    save_loc = here("output/plots/"))
generate.plots.zoom(star2,
                    ...
                    roundvar_vec = c("temp_ma02", "temp_ma03", "temp_ma04",
                                     "sal_ma02", "sal_ma03", "sal_ma04"),
                    name_vec = c("QC_StarTemp_rollmean_2hours_zoom2.png",
                                 "QC_StarTemp_rollmean_3hours_zoom2.png",
                                 "QC_StarTemp_rollmean_6hours_zoom2.png",
                                 "QC_StarSal_rollmean_2hours_zoom2.png",
                                 "QC_StarSal_rollmean_3hours_zoom2.png",
                                 "QC_StarSal_rollmean_6hours_zoom2.png"),
                    y_vec = c("Temperature (C)", "Temperature (C)", "Temperature (C)",
                              "Salinity (psu)", "Salinity (psu)", "Salinity (psu)"),
                    time_vec = c("2022-09-01 00:00:00", "2022-09-02 00:00:00"),
                    save_loc = here("output/plots/"))
...
generate.current.plots.zoom(TCM_current2,
                            ...
                            name_vec = c("QC_TCMCurr_rollmean_2hours_zoom2.png",
                                         "QC_TCMCurr_rollmean_3hours_zoom2.png",
                                         "QC_TCMCurr_rollmean_6hours_zoom2.png"),
                            time_vec = c("2022-09-01 00:00:00", "2022-09-07 00:00:00"),
                            save_loc = here("output/plots/"))
